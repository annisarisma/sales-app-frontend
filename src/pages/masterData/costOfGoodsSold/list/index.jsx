...
const CostOfGoodsSoldList = () => {
  ...
  useEffect(() => {
    document.title =
      'Products Cost Of Goods Sold List | Domiex - React JS Admin & Dashboard Template'
  }, [])
  ...
  return (
    <React.Fragment>
      <BreadCrumb subTitle="Transactions" title="Cost Of Goods Sold" />
      {/* header */}
      <div className="card">
        {/* card header  */}
        <div className="card-header">
          <div className="flex flex-wrap items-center gap-5">
            <div className="grow">
              <h6 className="mb-1 card-title">Cost Of Goods Sold</h6>
              <p className="text-gray-500 dark:text-dark-500">
                Track your cost of goods sold's progress to boost your stocks.
              </p>
            </div>
...
export default CostOfGoodsSoldList
