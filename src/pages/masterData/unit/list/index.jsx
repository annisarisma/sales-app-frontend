...
const UnitList = () => {
  ...
  useEffect(() => {
    document.title =
      'Products Unit List | Domiex - React JS Admin & Dashboard Template'
  }, [])
  ...
  return (
    <React.Fragment>
      <BreadCrumb subTitle="Transactions" title="Unit" />
      {/* header */}
      <div className="card">
        {/* card header  */}
        <div className="card-header">
          <div className="flex flex-wrap items-center gap-5">
            <div className="grow">
              <h6 className="mb-1 card-title">Unit</h6>
              <p className="text-gray-500 dark:text-dark-500">
                Track your unit's progress to boost your stocks.
              </p>
            </div>
