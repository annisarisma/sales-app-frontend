...
const PaymentMethodList = () => {
  ...
  useEffect(() => {
    document.title =
      'Products Payment Method List | Domiex - React JS Admin & Dashboard Template'
  }, [])
  ...
  return (
    <React.Fragment>
      <BreadCrumb subTitle="Transactions" title="Payment Method" />
      {/* header */}
      <div className="card">
        {/* card header  */}
        <div className="card-header">
          <div className="flex flex-wrap items-center gap-5">
            <div className="grow">
              <h6 className="mb-1 card-title">Payment Method</h6>
              <p className="text-gray-500 dark:text-dark-500">
                Track your payment method's progress to boost your stocks.
              </p>
            </div>
