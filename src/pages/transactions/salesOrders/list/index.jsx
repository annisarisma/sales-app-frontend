...
const SalesOrderList = () => {
  ...
  useEffect(() => {
    document.title =
      'Products Sales Order List | Domiex - React JS Admin & Dashboard Template'
  }, [])
  ...
  return (
    <React.Fragment>
      <BreadCrumb subTitle="Transactions" title="Sales Order" />
      {/* header */}
      <div className="card">
        {/* card header  */}
        <div className="card-header">
          <div className="flex flex-wrap items-center gap-5">
            <div className="grow">
              <h6 className="mb-1 card-title">Sales Order</h6>
              <p className="text-gray-500 dark:text-dark-500">
                Track your sales order's progress to boost your stocks.
              </p>
            </div>
