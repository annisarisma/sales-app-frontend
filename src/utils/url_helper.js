...
export const REACT_APP_HOSPITAL_STAFF_ATTENDANCE_API = apiUrl('/api/attendance')
export const REACT_APP_HOSPITAL_DEPARTMENT_API = apiUrl('/api/departments')
export const REACT_APP_HOSPITAL_EMPLOYEE_SALARY = apiUrl('/api/employee-salary')
...
export const REACT_APP_HOSPITAL_APPOINTMENT_APT = apiUrl('/api/appointments')
export const REACT_APP_MANAGE_REVIEWS = apiUrl('/api/manage-reviews')
