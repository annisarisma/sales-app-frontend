...
const BasicAccordion = () => {
  // Initialize with the index of the first open accordion (or null if none are open)
  const [openIndex, setOpenIndex] = useState(0)

  const handleToggle = (index) => {
    setOpenIndex((prevIndex) => (prevIndex === index ? null : index))
  }
  const [openIndex2, setOpenIndex2] = useState(3)
        ...
        <Accordion
          ...
          <div className="content">
            <p>
              ...
              File Size, Great Documentation, and Community Support are the main
              reasons for using Tailwind CSS.
            </p>
          </div>
        </Accordion>
        <Accordion
          ...
          <div className="content">
            <p>
              ...
              <code className="text-pink-500">config.</code> To adjust the main
              font style in Tailwind CSS, you can modify it by making changes in
              the “theme” part of your configuration file (
        ...
        <Accordion
          ...
          <div className="content">
            <p>
              ...
              the following command. We can also use utility classes to make a
              form with Tailwind CSS, use the easy-to-apply classes for
              backgrounds, borders, shadows, etc. Start by creating the form
              element and use the space-y-{`n`} class to add vertical spacing
              between the form controls.
            </p>
          </div>
        </Accordion>
      </div>
