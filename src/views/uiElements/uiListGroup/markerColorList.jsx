    ...
    <React.Fragment>
      <div className="col-span-12 sm:col-span-6 xl:col-span-4 card">
        <div className="card-header">
          <h6 className="card-title">Marker Color List</h6>
        </div>
        <div className="card-body">
          <ul className="flex flex-col gap-2 list-inside list-circle marker:text-green-500">
...
export default MarkerColorList
