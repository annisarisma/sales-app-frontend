      ...
      <div className="grid grid-cols-12 gap-5">
        <div className="col-span-12 md:col-span-6">
          <div className="flex flex-col gap-3">
            <div className="overflow-hidden progress-bar">
              <div className="relative w-1/2 text-white progress-bar-wrap bg-primary-500">
                <div className="progress-animate"></div>
              </div>
            </div>
            <div className="overflow-hidden progress-bar">
        ...
        <div className="col-span-12 md:col-span-6">
          <div className="flex flex-col gap-3">
            ...
            <div className="overflow-hidden progress-bar">
              <div className="w-3/5 text-gray-500 bg-gray-200 progress-bar-wrap">
                <div className="progress-animate"></div>
              </div>
            </div>
            <div className="overflow-hidden progress-bar">
              <div className="w-full text-white bg-gray-900 progress-bar-wrap">
                <div className="progress-animate"></div>
              </div>
            </div>
          </div>
