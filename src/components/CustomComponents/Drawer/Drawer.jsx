...
const DrawerContent = ({ children, isSimpleBar, customContentClass }) => {
  return isSimpleBar ? (
    <SimpleBar
...
const DrawerFooter = ({ children, footerClass }) => {
...
const Drawer = ({
  ...
  return (
    <>
      ...
      <div
        className={`drawer  ${positionClass} light:bg-white ${sizeClass} transition-transform duration-300 ease-in-out ${
          isAnimating
